                ...
                <div className={isMobile ? "main" : ''}>
                    <Row>
                        ...
                        <ul className="collection">
                            {props.content.warehouses.map((warehouse, index) => (
                                <li className="collection-item">
                                    <Row>
                                        ...
                                        <Col styles="s2">
                                            <input type="number" id={`quantityProduct${index}`} min={0} defaultValue={warehouse.quantity}/>
                                            <label>всего на складе: {warehouse.quantity}</label>
                                        </Col>
                                        <Col styles="s2">
